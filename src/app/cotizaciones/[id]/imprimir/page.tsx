    ...
    <div style={{ backgroundColor: "#f3f4f6", minHeight: "100vh", display: "flex", flexDirection: "column", alignItems: "center", padding: "30px 0" }} className="screen-bg">
      ...
      <div className="page" style={{ 
        ...
        <div style={{ 
          ...
          <div><strong>Banco:</strong> Banco del Bajío (BanBajío)</div>
          <div><strong>Beneficiario:</strong> Ikal Chukum S.A. de C.V.</div>
          <div><strong>Cuenta CLABE:</strong> 030910900018742631</div>
          <div style={{ marginTop: "3px", fontSize: "9.5px", fontStyle: "italic" }}>
            Enviar comprobante de pago a: <code>ventas@ikalchukum.com</code>
          </div>
        </div>
